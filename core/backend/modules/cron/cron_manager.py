...
class CronManager:
    ...
    def __init__(self, cron_user: str = None):
        """
    ...
    def _get_project_root(self) -> str:
        ...
        # Go up 4 levels: cron -> modules -> backend -> core -> root
    ...
    def _save_jobs(self, jobs_data: Dict[str, Dict[str, Any]]):
        """
    ...
    def _set_job_enabled(self, job, enabled: bool):
        """
    ...
    def update_job(self, job: CronJob) -> bool:
        ...
        try:
            ...
            # Set enabled state explicitly
            # Use a safer approach that works with all versions of python-crontab
            self._set_job_enabled(cron_job, job.enabled)
